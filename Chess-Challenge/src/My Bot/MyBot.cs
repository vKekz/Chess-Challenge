...
/// <summary>
/// This is the bot I made for the Sebastian Lague Chess-Challenge which placed #123 with an Elo result of 1457 and the first place being 2772.
/// </summary>
public class MyBot : IChessBot
{
    // Transposition Table
    Transposition[] _transpositionTable = new Transposition[1 << 25];
    ...
    // int _searchedNodes, _savedNodes, _hashedNodes = 0;
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        for (var depth = 1; depth <= 50; depth++)
        {
            ...
            // Console.WriteLine("(Depth " + depth + ") Best move: " + _bestMove.StartSquare.Name + _bestMove.TargetSquare.Name + " (" + _searchedNodes + " nodes / " + _savedNodes + " saved / " + _hashedNodes + " hashed) (took " + timer.MillisecondsElapsedThisTurn +"ms)");
        ...
        // Console.WriteLine("Evaluation: " + Evaluation(board, board.IsWhiteToMove));
        // Console.WriteLine("");
        // Console.WriteLine("Final move: "  + _bestMove.StartSquare.Name + _bestMove.TargetSquare.Name + " (took " + timer.MillisecondsElapsedThisTurn + "ms)");
